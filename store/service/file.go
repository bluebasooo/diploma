...
var (
	...
	isMocked         bool = false // tmp need service type
)

func GetFilePartInterval(userId string, id string, partId string) (map[string][]byte, error) {
	if isMocked {
	...
	interval := getIntervalOfParts(meta.PartSequence, partId)
