...
# Чтение точек из CSV с PCA координатами
points = {}
with open("user_clusters_pca.csv", "r") as f:  # файл с pca_x и pca_y
...
plt.xlabel("PCA 1")
plt.ylabel("PCA 2")
plt.title("Кластеризация пользователей (PCA проекция)")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.savefig("clustered_users_pca.png", dpi=300)
plt.close()

print("✅ Кластеры визуализированы в clustered_users_pca.png")
